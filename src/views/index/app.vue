            ...
            <div class="row">
                <div class="col-sm">
                    <b-tabs nav-class="tabs-border-adjust">
                        ...
                        <b-tab :title="$t('index.promotionReturn')" title-item-class="tab-item" title-link-class="tab-link">
                            <div class="jumbotron jumbotron-adjust text-light bg-dark jumboshade tab-rounded">
                        ...
                        <!-- 我的收益 -->
                        <b-tab :title="$t('index.myEarnings')" title-item-class="tab-item" title-link-class="tab-link">
                            <div class="jumbotron jumbotron-adjust text-light bg-dark jumboshade tab-rounded">
                                <div class="jumbotron jumbotron-adjust teamscore">
                                    <div class="row nomarginb">
                                        <div class="col-auto">
                                            <p class="h4">{{$t('index.eggHatching')}}</p>
                                        </div>
                                        <div class="col">
                ...
                <div class="col-sm">
                    <!-- 当前奖池 -->
                    <b-tabs nav-class="tabs-border-adjust">
                        <b-tab :title="$t('index.currentPrizePool')" active title-item-class="tab-item" title-link-class="tab-link">
                            <div class="jumbotron jumbotron-adjust text-light bg-dark jumboshade tab-rounded">
                                <tab-header :title="$t('index.rounds',{n:this.stat.currentRound})" :id="'currentRound'"></tab-header>
                                <div class="row nomarginb margin-top">
                                    <div class="col">
                                        <p class="h2 text-center">{{$t('index.eggWillHatching')}}<br>
                        ...
                        <!-- 排行榜 -->
                        <b-tab :title="$t('index.rankingList')" title-item-class="tab-item" title-link-class="tab-link">
                            <div class="jumbotron jumbotron-adjust text-light bg-dark jumboshade tab-rounded">
                                <!-- 赢家排行 -->
                                <tab-header :title="$t('index.winRanking')" :id="'player'"></tab-header>
                                <div class="row" style="position: relative;">
                                    <div class="col">
                                        <div class="jumbotron jumbotron-adjust teamscore">
                                            <table class="table">

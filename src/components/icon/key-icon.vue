<template>
    <svg class="svg-inline--fa fa-key fa-w-16l-tag-svg" :class="svgClass" aria-hidden="true" data-prefix="fas" data-icon="key" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
